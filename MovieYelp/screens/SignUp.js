        ...
        return(
            <ScrollView style={{backgroundColor: 'white'}}>
                <View style={styles.container}>
                    ...
                    style={styles.image}/> 
                     ...
                     <View 
            style = {[styles.inputContainerWrap, {borderColor: this.state.isFocused ? '#0779ef':'#eee'}]}>
                <Input
            ...
            style = {[styles.inputContainerWrap, {borderColor: this.state.isFocused ? '#0779ef':'#eee'}]}>
                ...
                onChangeText={this.onChangePassword}
                    ...
                    />
                     ...
                     <TouchableOpacity style={[styles.submitContainer, {backgroundColor: 'blue'}]}
            ...
            <Text style = {styles.submitText}>Create</Text>
                     ...
                     <View style={{flexDirection: 'row'}}>
                         ...
                         ) => this.props.navigation.navigate('Login')}> Login Here</Text>
                     </View>
                </View>
